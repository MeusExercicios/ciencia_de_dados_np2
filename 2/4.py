# QUESTÃO 4
# Enunciado:
# Crie um DataFrame com uma lista de 20 carros e seus preços. Em seguida, exiba apenas os 10 primeiros carros.

import pandas as pd

# Criando um dicionário com 20 carros e seus preços
valor = {
    "Carros": [
...
# Criando o DataFrame e selecionando os 10 primeiros carros
primeiro = pd.DataFrame(valor).head(10)
